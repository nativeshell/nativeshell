...
impl PlatformTexture {
    ...
    pub fn set_payload<T: TexturePayload>(&mut self, _payload: T) {}
}
...
impl PlatformTextureRegistry {
    ...
    pub fn register_texture<T: TexturePayload>(
        &self,
        _texture: Arc<Mutex<PlatformTexture>>,
    ) -> i64 {
        0
    }

    pub fn texture_frame_available(&self, _texture: i64) {}

    pub fn unregister_texture(&self, _texture: i64) {}
}
